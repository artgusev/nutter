...
class NutterApi(object):
    ...
    @abstractmethod
    def run_tests(self, pattern, cluster_id, cluster_conf, timeout, max_parallel_tests):
        pass

    @abstractmethod
    def run_test(self, testpath, cluster_id, cluster_conf, timeout):
        pass
...
class Nutter(NutterApi):
    ...
    def run_test(self, testpath, cluster_id = None, cluster_conf = None,
        ...
        result = self.dbclient.execute_notebook(
            test_notebook.path, cluster_id, cluster_conf,
            timeout=timeout, pull_wait_time=pull_wait_time, notebook_params=notebook_params)

        return result

    def run_tests(self, pattern, cluster_id, cluster_conf,
        ...
        return self._schedule_and_run(
            filtered_notebooks, cluster_id, cluster_conf, max_parallel_tests, timeout, poll_wait_time, notebook_params)
    ...
    def _schedule_and_run(self, test_notebooks, cluster_id, cluster_conf,
        ...
        for test_notebook in test_notebooks:
            ...
            func_scheduler.add_function(
                self._execute_notebook,
                test_notebook_path=test_notebook.path,
                cluster_id=cluster_id,
                cluster_conf=cluster_conf,
                timeout=timeout,
                pull_wait_time=pull_wait_time,
    ...
    def _execute_notebook(self, test_notebook_path, cluster_id, cluster_conf, timeout, pull_wait_time, notebook_params=None):
        result = self.dbclient.execute_notebook(test_notebook_path,
                                                cluster_id, cluster_conf, timeout, pull_wait_time, notebook_params)
